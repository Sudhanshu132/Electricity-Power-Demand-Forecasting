...
demand_series = demand_series.asfreq('h')  # Explicitly set hourly frequency to avoid warning
...
# SARIMA(1,1,1)x(1,1,1,24) captures daily seasonality
...
# === Step 5: Forecast next 3 months (~2200 hours) ===
forecast_steps = 2200
...
plt.title('SARIMA Forecast of Hourly Electricity Demand (Next 3 Months)')
plt.xlabel('Date')
...
output_path = "../FiltredDataset/FORECAST_DEMAND_2025_Q1.csv"
